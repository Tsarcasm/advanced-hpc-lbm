...
int initialise(const char* paramfile, const char* obstaclefile,
               t_param* params, t_speed** start_cells_ptr, t_speed** tmp_cells_ptr, t_speed** end_cells_ptr,
...
*/
float timestep(const t_param params, t_speed*restrict start_cells, t_speed*restrict tmp_cells, t_speed*restrict end_cells, int*restrict obstacles);
int accelerate_flow(const t_param params, t_speed*restrict cells, int*restrict obstacles);
int propagate(const t_param params, t_speed*restrict cells, t_speed*restrict tmp_cells, int ii, int jj);
float collision(const t_param params, t_speed*restrict cells, t_speed*restrict tmp_cells, int*restrict obstacles, int ii, int jj);
int write_values(const t_param params, t_speed* cells, int* obstacles, float* av_vels);

/* finalise, including freeing up allocated memory */
int finalise(const t_param* params, t_speed** start_cells_ptr, t_speed** tmp_cells_ptr, t_speed** end_cells_ptr,
             int** obstacles_ptr, float** av_vels_ptr);
...
int main(int argc, char* argv[])
{
  ...
  t_speed* start_cells     = NULL;    /* grid containing fluid densities */
  t_speed* tmp_cells = NULL;    /* scratch space */
  t_speed* end_cells = NULL;    
...
float timestep(const t_param params, t_speed *restrict start_cells, t_speed *restrict tmp_cells, t_speed *restrict end_cells, int *restrict obstacles)
{
  ...
  for (int jj = 0; jj < params.ny; jj++)
  {
    ...
    {
      propagate(params, start_cells, tmp_cells, ii, jj);
      tot_vel += collision(params, end_cells, tmp_cells, obstacles, ii, jj);
    }
  }
  return tot_vel;
}
               ...
               int** obstacles_ptr, float** av_vels_ptr)
{
  ...
  */
  ...
  /* main grid */
  *start_cells_ptr = (t_speed*)malloc(sizeof(t_speed) * (params->ny * params->nx));
  if (*start_cells_ptr == NULL) die("cannot allocate memory for cells", __LINE__, __FILE__);
  ...
  *tmp_cells_ptr = (t_speed*)malloc(sizeof(t_speed) * (params->ny * params->nx));
  ...
  /* 'helper' grid, used as scratch space */
  *end_cells_ptr = (t_speed*)malloc(sizeof(t_speed) * (params->ny * params->nx));
  ...
  *obstacles_ptr = malloc(sizeof(int) * (params->ny * params->nx));
  ...
  for (int jj = 0; jj < params->ny; jj++)
  {
    ...
    {
      /* centre */
      (*start_cells_ptr)[ii + jj*params->nx].speeds[0] = w0;
      /* axis directions */
      (*start_cells_ptr)[ii + jj*params->nx].speeds[1] = w1;
      (*start_cells_ptr)[ii + jj*params->nx].speeds[2] = w1;
      (*start_cells_ptr)[ii + jj*params->nx].speeds[3] = w1;
      (*start_cells_ptr)[ii + jj*params->nx].speeds[4] = w1;
      /* diagonals */
      (*start_cells_ptr)[ii + jj*params->nx].speeds[5] = w2;
      (*start_cells_ptr)[ii + jj*params->nx].speeds[6] = w2;
      (*start_cells_ptr)[ii + jj*params->nx].speeds[7] = w2;
      (*start_cells_ptr)[ii + jj*params->nx].speeds[8] = w2;
    }
  }
